...
<head>
    ...
    <link rel="stylesheet" href="resources/assets/css/login_styles.css">
    <style>
        /* Add this CSS to style the video background */
        body, html {
            height: 100%;
            margin: 0;
            overflow: hidden;
...
<body>
    ...
    <video autoplay muted loop class="video-background">
        <source src="resources\images\Screen Recording 2025-03-08 195633.mp4" type="video/mp4">
    ...
    <div class="container" id="signIn" >
        ...
        <p class="or">
            <h3 style=text-align:center; >Welcome To Ratnam College's<br> Attendance System</h3>
        </p>
